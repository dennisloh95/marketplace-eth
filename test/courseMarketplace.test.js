...
contract("CourseMarketplace", (accounts) => {
  ...
  describe("Purchase the new course", () => {
    ...
    it("should match the purchased data of the course purchased by buyer", async () => {
      ...
      assert.equal(course.owner, buyer, `Buyer should be ${buyer}!`);
      assert.equal(
        course.state,
        expectedState,
  ...
  describe("Transfer ownership", () => {
    ...
    it("should transfer ownership to 3rd address from 'accounts'", async () => {
      ...
      assert.equal(owner, accounts[2], "Contract owner is not second account");
    });
  ...
  describe("Normal withdraw", () => {
    ...
    it("should fail when withdrawing OVER limmit balance", async () => {
      await catchRevert(
